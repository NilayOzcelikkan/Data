write("", "C:\Users\nilay\eclipse-workspace-salt\optimization/Deneme2/R/SPREAD.Wilcoxon.tex",append=FALSE)
resultDirectory<-"C:\Users\nilay\eclipse-workspace-salt\optimization/Deneme2/data"
latexHeader <- function() {
  write("\\documentclass{article}", "C:\Users\nilay\eclipse-workspace-salt\optimization/Deneme2/R/SPREAD.Wilcoxon.tex", append=TRUE)
